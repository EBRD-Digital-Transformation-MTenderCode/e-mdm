...
--changeset msambulat:address_regional_scheme_used
CREATE TABLE public.address_regional_scheme_used (
  id              BIGINT     NOT NULL PRIMARY KEY,
  country_code    VARCHAR(2) NOT NULL UNIQUE,
  list_schemes_id BIGINT     NOT NULL REFERENCES list_schemes (id)
);

--changeset msambulat:address_regional_scheme_used_filling_data context:!test
INSERT INTO public.address_regional_scheme_used(id, country_code, list_schemes_id)
VALUES (1, 'MD', 2 /* CUATM */);


--changeset msambulat:address_regional_schemes
CREATE TABLE public.address_regional_schemes (
  id              BIGINT     NOT NULL PRIMARY KEY,
  list_schemes_id BIGINT     NOT NULL REFERENCES list_schemes (id),
...
--changeset msambulat:address_regional_schemes_filling_data context:!test
INSERT INTO public.address_regional_schemes(id, list_schemes_id, country_code, code)
...
--changeset msambulat:address_regional_schemes_i18n
CREATE TABLE public.address_regional_schemes_i18n (
  id                         BIGINT     NOT NULL PRIMARY KEY,
  address_regional_scheme_id BIGINT     NOT NULL REFERENCES address_regional_schemes (id),
  language_code              VARCHAR(2) NOT NULL,
  description                TEXT       NOT NULL,
  UNIQUE (address_regional_scheme_id, language_code)
);

--changeset msambulat:address_regional_schemes_i18n_filling_data context:!test
INSERT INTO public.address_regional_schemes_i18n(id, address_regional_scheme_id, language_code, description)
